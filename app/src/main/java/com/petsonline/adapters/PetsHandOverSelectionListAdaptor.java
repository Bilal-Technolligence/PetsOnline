...
public class PetsHandOverSelectionListAdaptor extends RecyclerView.Adapter<PetsHandOverSelectionListAdaptor.MyHolder> {
    Context ct;
    ArrayList<MyPet> al;
    DatabaseReference databaseReference;
    String CareTaker;

    public PetsHandOverSelectionListAdaptor(Context cont, ArrayList<MyPet> al,String c) {
        this.ct = cont;
        this.al = al;
        CareTaker = c;
    ...
    @Override
    public void onBindViewHolder(PetsHandOverSelectionListAdaptor.MyHolder holder, final int position) {
