...
import com.petsonline.adapters.PetsHandOverToMeAdaptor;
...
public class HandoverPetsToMeActivity extends AppCompatActivity {
    public FirebaseAuth mAuth;
    ArrayList<MyPet> al;
    PetsHandOverToMeAdaptor md;
    RecyclerView rv;
    MyPet p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handover_pets_to_me);
        try {
            getSupportActionBar().setTitle("Handover Pets to Me");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot eachAdRecord : dataSnapshot.getChildren()) {
                        String HandoverTo = "";
                        if (eachAdRecord.child("HandoverTo").exists())
                            HandoverTo = Objects.requireNonNull(eachAdRecord.child("HandoverTo").getValue()).toString().trim();

                        if (!HandoverTo.equals("") && HandoverTo.equalsIgnoreCase(mAuth.getUid())) {
                            MyPet p = new MyPet();
                    ...
                    if (!al.isEmpty()) {
                        ...
                        md = new PetsHandOverToMeAdaptor(HandoverPetsToMeActivity.this, al,CareTaker);
                        rv.setAdapter(md);
                    } else {
