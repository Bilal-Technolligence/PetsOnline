...
public class ChatWithUserActivity extends AppCompatActivity {
    ...
    private String date;
    //private Button handOverYourPetsButton;
...
/*
        handOverYourPetsButton.setOnClickListener(view -> startActivity(new Intent(ChatWithUserActivity.this,MyPetsHandOverActivity.class).putExtra("CareTaker",SellerID)));
        ...
        dref.child("MessagesCareTaker").child(chat_id).addValueEventListener(valueEventListener3 = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    chatAdapter = new ChatAdapter(messageAttrs, ChatWithUserActivity.this, ChatWithUserActivity.this);
                                    ...
                                    .addOnSuccessListener(taskSnapshot ->
                                            taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(task -> {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(ChatWithUserActivity.this, "Unable to Send Image, try again", Toast.LENGTH_SHORT).show();
                                                }
