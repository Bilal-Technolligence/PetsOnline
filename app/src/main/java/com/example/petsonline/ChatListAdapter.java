...
public class ChatListAdapter extends RecyclerView.Adapter<com.example.petsonline.ChatListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.petsonline.ChatListAdapter.ViewHolder(view);
    }
